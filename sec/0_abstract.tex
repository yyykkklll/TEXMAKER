...
\begin{abstract}
    ...
    Our framework introduces two core components: a Bidirectional Decoupling Alignment Module and a Mamba State Space Model (SSM) for efficient fusion. 
    ...
    To enforce this separation and ensure identity purity, we design a multi-task loss strategy comprising an adversarial loss that actively suppresses the influence of clothing-related features, and a kernel-based orthogonal constraint that ensures statistical independence. Furthermore, we pioneer the integration of the Mamba SSM into cross-modal Re-ID as an efficient fusion module. 
