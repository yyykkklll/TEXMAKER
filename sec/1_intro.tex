...
To address this challenge, we propose a novel framework centered on MLLM-supervised feature decoupling.
Instead of treating features holistically, we draw on the style-clustering paradigm~\cite{jiangModelingThousandsHuman2025} and leverage an MLLM to automatically generate fine-grained, separate identity and clothing descriptions.
