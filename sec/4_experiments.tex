...
Within BDAM, both bidirectional cross-attention and gating are crucial: removing cross-attention drops R1 to 71.39\%, and removing the gate also degrades performance.
